...
public class Boss extends Enemy {
    ...
    public static class DemonKingDin extends Boss {
        public DemonKingDin() {
            super("Demon-King Din", 1000, 2, 75, 75, 25, 0.25, 0.25, 20);
            ...
            ultimateAttack = new EnemySkill("[ULTIMATE] Realm of Suffering", "Creates a domain of absolute darkness where pain becomes reality", 2.50, 80, DamageType.PHYSICAL, TargetType.SINGLE);
        }
    }
    // chap 4
    public static class Abaddon extends Boss {
        public Abaddon() {
            super("Abaddon", 600, 2, 70, 70, 18, 0.23, 0.23, 19);
            ...
            ultimateAttack = new EnemySkill("[ULTIMATE] Apocalypse Call", "Summons the end of days in a cataclysmic explosion of power", 2.50, 80, DamageType.PHYSICAL, TargetType.SINGLE);
        }
    }
    ...
    public static class Kamish extends Boss {
        public Kamish() {
            super("Kamish", 400, 2, 50, 50, 12, 0.21, 0.21, 18);
            ...
            ultimateAttack = new EnemySkill("[ULTIMATE] Skyfall Descent", "Plummets from the heavens with the force of a meteor", 2.30, 80, DamageType.PHYSICAL, TargetType.SINGLE);
        }
    }
    // chap 2
    public static class MiningCable extends Boss {
        public MiningCable() {
            ...
            ultimateAttack = new EnemySkill("[ULTIMATE] Dragon's Dive", "A devastating aerial assault that strikes with immense force", 2.00, 80, DamageType.PHYSICAL, TargetType.SINGLE);
        }
    }
    // chap 1
    public static class Frankenstein extends Boss {
        public Frankenstein() {
            ...
            ultimateAttack = new EnemySkill("[ULTIMATE] Enderman's Wrath", "Unleashes the full power of the void in a chaotic burst", 1.90, 80, DamageType.PHYSICAL, TargetType.SINGLE);
        }
    }
