...
public class Game {
    ...
    public void initializeGame() {
        ...
        weapons.add(new Weapon("BW001", "Wooden Bow", WeaponType.BOW, "", new WeaponSkill("Basic Attack", "", 1.15, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Skill Attack", "", 1.73, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Ultimate Attack", "", 2.25, 0, DamageType.PHYSICAL, TargetType.SINGLE), 20, Rarity.COMMON));
        weapons.add(new Weapon("SW001", "Wooden Sword", WeaponType.SWORD, "", new WeaponSkill("Basic Attack", "", 1.15, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Skill Attack", "", 1.73, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Ultimate Attack", "", 2.25, 0, DamageType.PHYSICAL, TargetType.SINGLE), 20, Rarity.COMMON));
        weapons.add(new Weapon("MGS001", "Wooden Staff", WeaponType.MAGIC_STAFF, "", new WeaponSkill("Basic Attack", "", 1.15, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Skill Attack", "", 1.73, 0, DamageType.MAGICAL, TargetType.SINGLE), new WeaponSkill("Ultimate Attack", "", 2.25, 0, DamageType.MAGICAL, TargetType.SINGLE), 20, Rarity.COMMON));
        weapons.add(new Weapon("BS001", "Wooden Broadsword", WeaponType.BROADSWORD, "", new WeaponSkill("Basic Attack", "", 1.15, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Skill Attack", "", 1.73, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Ultimate Attack", "", 2.25, 0, DamageType.PHYSICAL, TargetType.SINGLE), 20, Rarity.COMMON));
        weapons.add(new Weapon("DR001", "Wooden Dagger", WeaponType.DAGGER, "", new WeaponSkill("Basic Attack", "", 1.15, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Skill Attack", "", 1.73, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Ultimate Attack", "", 2.25, 0, DamageType.PHYSICAL, TargetType.SINGLE), 20, Rarity.COMMON));
        weapons.add(new Weapon("MGSW001", "Wooden Magic Sword", WeaponType.MAGIC_SWORD, "", new WeaponSkill("Basic Attack", "", 1.15, 0, DamageType.PHYSICAL, TargetType.SINGLE), new WeaponSkill("Skill Attack", "", 1.73, 0, DamageType.MAGICAL, TargetType.SINGLE), new WeaponSkill("Ultimate Attack", "", 2.25, 0, DamageType.MAGICAL, TargetType.SINGLE), 20, Rarity.COMMON));
