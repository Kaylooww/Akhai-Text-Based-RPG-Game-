...
public class Game {
    ...
    public void explore() {
        ...
        if (Math.random() <= encounterRate) {
            if(currentChapter < 3) {
                System.out.println("🚨 You encountered a " + ColorUtil.red("Common enemy") + "!");
                battleCommon();
            } else if (currentChapter == 3) {
                if(Math.random() >= 0.75){
                    System.out.println("🚨 Warning! You encountered an " + ColorUtil.redBright("Elite enemy") + "!");
                    battleElite();
                } else {
                    System.out.println("🚨 You encountered a " + ColorUtil.red("Common enemy") + "!");
                    battleCommon();
    ...
    public void battleCommon() {
        ...
        System.out.println("🚨 A wild " + ColorUtil.red(enemy.getName()) + " appears!");
        delay(1000);
    ...
    public void battleElite() {
        ...
        System.out.println("🚨 A wild " + ColorUtil.redBright(enemy.getName()) + " appears!");
        delay(1000);
    ...
    private void handlePlayerDefeat() {
        ...
        if (!player.hasResurrected()) {
            System.out.println("Remember: You have your resurrection available for next playthrough!");
        }

        //TODO ascii art for DEFEAT
        gameRunning = false;
        System.out.println("You have been defeated. Thanks for playing AKHAI!");
    }
