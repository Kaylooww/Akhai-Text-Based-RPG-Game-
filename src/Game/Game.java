...
public class Game {
                        ...
                        for (String line : bannerLines) {
                            ...
                            for (int i = 0; i < line.length(); i++) {
                                ...
                                if (c == '░') {
                                    ...
                                    coloredLine += ColorUtil.brightRedBold("█");
                                } else {
                                    coloredLine += ConsoleColors.RESET + c;
                                }
                            }
            ...
            switch(choice) {
                ...
                case 3:
                    if(!(enemy instanceof Boss)){
                        if (Math.random() > 0.85) {
                            System.out.println(ColorUtil.brightCyanBold("\t\t\tYou successfully fled!"));
                            inBattle = false;
                            return -1;
                        } else {
                            System.out.println(ColorUtil.brightRedBold("\t\t\tYou failed to flee!"));
                        }
                        hasActed = true;
                    }else{
    ...
    private void handlePlayerDefeat() {
        delay(1500);
        System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
        System.out.println(ColorUtil.brightRedBold(" ".repeat(31)+"💀 You have been slain..."));
        delay(2500);
        System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
        String[] bannerLines = {
                "                   ▓█████▄ ▓█████   █████▒▓█████ ▄▄▄     ▄▄▄█████▓",
    ...
    private void handlePlayerDefeatFromMiniBoss() {
        delay(1500);
        System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
        System.out.println(ColorUtil.brightRedBold(" ".repeat(29)+"💀 You have been defeated..."));
        delay(2500);
        System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
        String[] bannerLines = {
                "                   ▓█████▄ ▓█████   █████▒▓█████ ▄▄▄     ▄▄▄█████▓",
