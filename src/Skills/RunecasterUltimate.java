...
public class RunecasterUltimate extends Skill{
    public RunecasterUltimate(String name, String description, double multiplier, int energyCost, DamageType damageType, TargetType targetType) {
